# Exercise for Week 2 {.unnumbered}
...
We can also assign a list of things to a variable, including other variables:

```{python}
mylist = [1, 2, 3, "A", "B", "C", name]
print(mylist)
```
...
Read @inskipTheirOwnWords2015 and @Wiering2025_ImpactPandemicMusicologists and summarize their findings.
:::
